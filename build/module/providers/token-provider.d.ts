...
export declare const WETH_GNOSIS: Token;
export declare const USDC_GNOSIS: Token;
export declare const USDT_GNOSIS: Token;
export declare const WBTC_GNOSIS: Token;
export declare const HONEY_GNOSIS: Token;
export declare const AGVE_GNOSIS: Token;
export declare const GIV_GNOSIS: Token;
export declare const TEC_GNOSIS: Token;
export declare const GNO_GNOSIS: Token;
